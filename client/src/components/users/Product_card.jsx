  ...
  return (
    ...
    >
      ...
      {pro.quantity === 0 ? (
        ...
        >
          <Heart
            className={`h-6 w-6 border border-none opacity-65 ${
              !pro.wished && 'opacity-25'
            }`}
      ...
      <div
        ...
        onClick={() => navigate(`/user/viewProduct/${pro._id}`)}
      >
        <img
          ...
          <div className=" w-full flex flex-col pb-2 ">
            <div className="flex ">
              <div className=" w-[16%] flex  justify-start ">
                <img
                  className="w-10 h-10 rounded-full mt-2 border border-gray-400"
                  src="https://img.freepik.com/free-vector/shop-with-sign-open-design_23-2148544029.jpg"
                  alt="shop"
                />
              </div>
            ...
            <div className="">
              <p className="text-lg font-semibold text-[13px] italic mt-2">
                {pro.modelnumber}
              </p>
              <p
              ...
              >
                Model: {pro.modelnumber}, #{pro.productType}, #{pro.category}{' '}
                #electronics
              </p>
            </div>
          </div>
