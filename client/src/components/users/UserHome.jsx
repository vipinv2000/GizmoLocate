...
const UserHome=()=> {
  ...
  const recentOrders = [
    { id: 1, product: 'Designer Watch', date: '2024-03-10', status: 'Delivered', amount: '$299.99' },
    { id: 2, product: 'Leather Bag', date: '2024-03-09', status: 'In Transit', amount: '$199.99' },
    { id: 3, product: 'Sunglasses', date: '2024-03-08', status: 'Processing', amount: '$149.99' },
  ];
